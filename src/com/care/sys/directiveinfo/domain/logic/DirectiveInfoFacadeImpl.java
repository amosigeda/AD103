...
public class DirectiveInfoFacadeImpl implements DirectiveInfoFacade {
	...
	public DataList getDirectiveInfoListByVo(DirectiveInfo vo)
		...
		DataList list = new DataList(
				directiveInfoDao.getDirectiveInfoListByVo(vo));
		list.setTotalSize(directiveInfoDao.getDirectiveInfoCount(vo));
		return list;
	}

	public List<DataMap> getImsiAndResourceInfo(DirectiveInfo vo) {
		return directiveInfoDao.getImsiAndResourceInfo(vo);
	}

	public Integer insertLog(DirectiveInfo vo) throws SystemException {
		return directiveInfoDao.insertLog(vo);
	}
