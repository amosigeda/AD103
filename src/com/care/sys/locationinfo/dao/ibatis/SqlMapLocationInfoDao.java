...
public class SqlMapLocationInfoDao extends SqlMapClientDaoSupport implements LocationInfoDao{
	...
	public int insertTestInfo(LocationInfo vo) throws DataAccessException {
		logger.debug("insertTestInfo(LocationInfo vo)");
		return getSqlMapClientTemplate().update("insertTestInfo", vo);
	}

	public List<DataMap> getTestInfo(LocationInfo vo)
			throws DataAccessException {
		logger.debug("getTestInfo(LocationInfo vo)");
		return getSqlMapClientTemplate().queryForList("getTestInfo", vo);
	}

	public int getTestInfoCount(LocationInfo vo) throws DataAccessException {
		logger.debug("getTestInfoCount(LocationInfo vo)");
		return (Integer)getSqlMapClientTemplate().queryForObject("getTestInfoCount", vo);
	}
